...
import { FiSave, FiCheck, FiSmartphone } from "react-icons/fi";
import { apiFetch } from "@/lib/api";
import RequirePermission from "@/components/RequirePermission";

export default function VersionAppPage() {
      ...
      <div className="p-4 p-md-5" style={{ maxWidth: 640 }}>
        <div className="mb-4">
          ...
          <p className="text-secondary mb-0">
            Como la app no está en Play Store, esta pantalla controla el aviso de actualización que ven los
            usuarios al abrirla.
          </p>
        </div>
          ...
          <div className="card border-0 shadow-sm rounded-4">
            <div className="card-body p-4">
              <h5 className="fw-semibold mb-3 d-flex align-items-center gap-2">
                <FiSmartphone size={18} /> Configuración de versión
              </h5>
              <form onSubmit={handleSubmit}>
                <div className="row g-2 mb-3">
                  ...
                  <div className="col-6">
                    ...
                    <p className="form-text small">
                      Por debajo de esta, la app bloquea el uso hasta actualizar.
                    </p>
                  </div>
                </div>
                ...
                <div className="d-flex gap-2 align-items-center">
                  <button
                    type="submit"
                    disabled={saving}
                    className="btn btn-brand rounded-3 d-flex align-items-center gap-1"
                  >
