...
const NAV = [
  {
    ...
    items: [
      ...
      { key: "zonas", label: "Zonas", icon: FiMapPin, permKey: "zonas", href: "/maestros/zonas" },
  ...
  { type: "link", key: "reportes", label: "Reportes", icon: FiBarChart2, permKey: "reportes", href: "/reportes" },
  {
    ...
    items: [
      ...
      { key: "inventariosArticulos", label: "Artículos", icon: FiPackage, permKey: "inventariosArticulos", href: "/inventarios/articulos" },
...
export default function Sidebar() {
  ...
  useEffect(() => {
    setPerms({
      ...
      zonas: hasPermission("menu.maestros.zonas"),
      ...
      inventariosArticulos: hasPermission("menu.inventarios.articulos"),
